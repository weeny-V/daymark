...
- **Tasks** - create, complete, organize, filter, and delete tasks with projects, tags, priorities, and due dates.
...
- **Responsive navigation** - use a seven-destination desktop sidebar or a focused mobile bottom bar with Today, Tasks, Habits, Focus, and a More sheet for Upcoming, Notes, and Settings.

All productivity data is stored locally in the current browser profile. Daymark does not require an account or sync data across devices. Use **Settings > Data backup** to download a JSON copy of tasks, projects, tags, settings, notes, and habits. Restoring a backup validates the whole file and asks for confirmation before replacing local data.
...
src/
  ...
  types/            Domain types
  views/            Routed Today, Tasks, Upcoming, Habits, Focus, Notes, and Settings pages
```
...
The interface is designed and tested around representative widths of 375 px, 768 px, and 1440 px. Below 768 px, the bottom bar keeps Today, Tasks, Habits, and Focus directly available while the More sheet contains Upcoming, Notes, and Settings. Interactive behavior should remain keyboard accessible, expose visible focus states, and respect `prefers-reduced-motion`.
